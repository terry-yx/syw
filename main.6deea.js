(function () {
    ...
    function boot () {
        ...
        var bundledScript = settings.debug ? 'src/project.dev.js' : 'src/project.a0eb1.js';
        if (jsList) {
    ...
    if (false) {
        (function () {
            ...
            require('src/settings.e33ed.js');
            require(window._CCSettings.debug ? 'cocos2d-js.js' : 'cocos2d-js-min.10166.js');
    ...
    if (window.document) {
        ...
        cocos2d.async = true;
        cocos2d.src =  'cocos2d-js-min.10166.js';
